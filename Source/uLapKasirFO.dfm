object frmLapKasirFO: TfrmLapKasirFO
  Left = 0
  Top = 0
  Caption = 'Laoran Kasir FO'
  ClientHeight = 661
  ClientWidth = 1271
  Color = clBtnFace
        ...
        object cxgrd1: TcxGrid
          ...
          object cxgrd1DBTableView1: TcxGridDBTableView
            ...
            DataController.Summary.FooterSummaryItems = <
              item
                Format = ',0'
                Column = cxgrdbclmncxgrd1DBTableView1ColumnSubTotal
              end>
            DataController.Summary.SummaryGroups = <>
            OptionsSelection.CellSelect = False
  ...
  object zqryDetail: TZQuery
    ...
    object zqryDetailjns_reservasi: TStringField
  ...
  object qGetBill: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select a.no_nota, a.dt_nota, a.cara_bayar, a.usr_upd, a.nama_tam' +
        'u, a.no_kamar,'
      'c.jenis as jns_reservasi,'
      ...
      'left join master.mtransaction b on b.id_trans=a.id_trans'
        ...
        'where a.id_trans='#39'102'#39' and a.isdelete='#39'0'#39' and a.iscancel='#39'0'#39' and' +
        ' a.isclosed='#39'1'#39' and a.jns_pembayaran is null'
      'and a.shift=:pshift'
    ...
    object qGetBilljns_reservasi: TStringField
      Alignment = taCenter
      FieldName = 'jns_reservasi'
      ReadOnly = True
      Size = 100
  ...
  object RepNota_A4: TfrxReport
    ...
    Datasets = <
      ...
      item
        DataSet = frxdbTotalLap
        DataSetName = 'frxdbTotalLap'
      end>
    Variables = <>
    Style = <>
  ...
  object RepNota_A4_new: TfrxReport
    Version = '6.8'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.906000000000000000
        Condition = 'frxdbqryDetail."cara_bayar"'
      end
      object MasterData1: TfrxMasterData
        FillType = ftBrush
        Frame.Typ = []
  ...
  object qTotalLap: TZReadOnlyQuery
    Connection = DataModule1.zconHotel
    SQL.Strings = (
      'select a.kd_kasir, a.no_kasir,'
      
        'cast((select coalesce(sum(dibayar)) from accfin.kasir_detail whe' +
        're kd_kasir=:kd_kasir and cara_bayar='#39'TUNAI'#39')as numeric(17)) as ' +
        'total_tunai,'
      
        'cast((select coalesce(sum(dibayar)) from accfin.kasir_detail whe' +
        're kd_kasir=:kd_kasir and cara_bayar='#39'KREDIT'#39')as numeric(17)) as' +
        ' total_kredit,'
      
        'cast((select coalesce(sum(dibayar)) from accfin.kasir_detail whe' +
        're kd_kasir=:kd_kasir)as numeric(17)) as total_all'
      'from accfin.kasir a'
      'where a.kd_kasir=:kd_kasir')
    Params = <
      item
        DataType = ftUnknown
        Name = 'kd_kasir'
    ...
    object qTotalLapkd_kasir: TLargeintField
      FieldName = 'kd_kasir'
      ReadOnly = True
    end
    object qTotalLapno_kasir: TStringField
      FieldName = 'no_kasir'
      ReadOnly = True
      Size = 30
    end
    object qTotalLaptotal_tunai: TFloatField
      FieldName = 'total_tunai'
      ReadOnly = True
    end
    object qTotalLaptotal_kredit: TFloatField
      FieldName = 'total_kredit'
      ReadOnly = True
    end
    object qTotalLaptotal_all: TFloatField
      FieldName = 'total_all'
      ReadOnly = True
    end
  end
  object frxdbTotalLap: TfrxDBDataset
    UserName = 'frxdbTotalLap'
    CloseDataSource = False
    FieldAliases.Strings = (
      'kd_kasir=kd_kasir'
      'no_kasir=no_kasir'
  ...
  object qGetBillKredit: TZReadOnlyQuery
    Connection = DataModule1.zconHotel
    SQL.Strings = (
      
        'select a.no_nota, a.dt_nota, a.jns_pembayaran as cara_bayar, a.u' +
        'sr_upd, a.nama_tamu, a.no_kamar, a.total,'
      
        'cast((case when a.cara_bayar='#39'KREDIT'#39' then '#39'Billing Issue Credit' +
        #39
      'end)  as character varying(100)) as description,'
      'c.jenis as jns_reservasi'
      'from transaksi.nota a'
      'left join master.mtransaction b on b.id_trans=a.id_trans'
        ...
        'where a.id_trans='#39'102'#39' and a.isdelete='#39'0'#39' and a.iscancel='#39'0'#39' and' +
        ' a.isclosed='#39'1'#39' and a.cara_bayar='#39'KREDIT'#39
      'and a.shift=:pshift'
      
        'and a.dt_upd between to_timestamp (:ptgl0,'#39'dd/mm/yyyy'#39') and to_t' +
        'imestamp (:ptgl1,'#39'dd/mm/yyyy'#39') + interval '#39'23 hour 59 minutes'#39
    ...
    object qGetBillKreditno_nota: TStringField
      FieldName = 'no_nota'
      ReadOnly = True
    end
    object qGetBillKreditdt_nota: TDateTimeField
      FieldName = 'dt_nota'
      ReadOnly = True
    end
    object qGetBillKreditcara_bayar: TStringField
      FieldName = 'cara_bayar'
      ReadOnly = True
    end
    object qGetBillKreditusr_upd: TStringField
      FieldName = 'usr_upd'
      ReadOnly = True
      Size = 30
    end
    object qGetBillKreditnama_tamu: TStringField
      FieldName = 'nama_tamu'
      ReadOnly = True
      Size = 30
    end
    object qGetBillKreditno_kamar: TStringField
      FieldName = 'no_kamar'
      ReadOnly = True
      Size = 10
    end
    object qGetBillKredittotal: TFloatField
      FieldName = 'total'
      ReadOnly = True
    end
    object qGetBillKreditdescription: TStringField
      FieldName = 'description'
      ReadOnly = True
      Size = 100
    end
    object qGetBillKreditjns_reservasi: TStringField
      FieldName = 'jns_reservasi'
      ReadOnly = True
      Size = 100
    end
