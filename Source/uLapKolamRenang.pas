...
type
  ...
  TfrmLapKolamRenang = class(TForm)
    pnlHeader: TPanel;
    advpnlNav: TAdvPanel;
...
var
  frmLapKolamRenang: TfrmLapKolamRenang;
...
procedure TfrmLapKolamRenang.AdvGlbtnExportClick(Sender: TObject);
var excel : Variant;
    appPath, ttl :string;
begin
...
procedure TfrmLapKolamRenang.InsertMemTabel;
begin
  try
...
procedure TfrmLapKolamRenang.CetakRekap;
begin
...
constructor TfrmLapKolamRenang.Create(AOwner: TComponent; aTag: Integer);
begin
  inherited Create(AOwner);
  vTag := aTag;
end;

procedure TfrmLapKolamRenang.CetakDetail;
begin
...
procedure TfrmLapKolamRenang.AdvGlbtnPrintClick(Sender: TObject);
begin
...
procedure TfrmLapKolamRenang.AdvGlBtnRefreshClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;

procedure TfrmLapKolamRenang.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 Action:= caFree;
 frmLapKolamRenang:=nil;
end;

procedure TfrmLapKolamRenang.FormShow(Sender: TObject);
begin
...
procedure TfrmLapKolamRenang.OpenDataset(idx:integer);
begin
  try
    case idx of
      0 : begin
...
procedure TfrmLapKolamRenang.tsDetailShow(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;

procedure TfrmLapKolamRenang.UpdateAccessControls;
...
procedure TfrmLapKolamRenang.wwDbDtpFromCloseUp(Sender: TObject);
var dt: TDateTime;
    y,m,d: Word;
begin
...
procedure TfrmLapKolamRenang.glbtnCLoseClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmLapKolamRenang.glbtnGoClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;
