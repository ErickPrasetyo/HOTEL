...
procedure TfrmPostingHK.AdvGlBtnRefreshClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;

procedure TfrmPostingHK.Batal1Click(Sender: TObject);
var s: string;
begin
   try
       Exec.Close;
...
constructor TfrmPostingHK.Create(AOwner: TComponent; aTag: Integer);
begin
  inherited Create(AOwner);
  vTag := aTag;
end;

procedure TfrmPostingHK.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 Action:= caFree;
 frmPostingHK:=nil;
end;

procedure TfrmPostingHK.FormShow(Sender: TObject);
begin
...
procedure TfrmPostingHK.OpenDataset(idx:integer);
begin
  try
    case idx of
      0 : begin
...
procedure TfrmPostingHK.qRekapAfterOpen(DataSet: TDataSet);
begin
  UpdateAccessControls;
end;

procedure TfrmPostingHK.UnBatal1Click(Sender: TObject);
var s: string;
begin
   try
       Exec.Close;
...
procedure TfrmPostingHK.UpdateAccessControls;
...
procedure TfrmPostingHK.wwDbDtpFromCloseUp(Sender: TObject);
var dt: TDateTime;
    y,m,d: Word;
begin
...
procedure TfrmPostingHK.glbtnCLoseClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmPostingHK.glbtnGoClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;
