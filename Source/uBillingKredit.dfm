object frmBillingKredit: TfrmBillingKredit
  Left = 0
  Top = 0
  Caption = 'Nota Kredit'
  ClientHeight = 661
  ...
  object pnlHeader: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 49
      AutoSize = False
      Caption = 'Berisi data transaksi Piutang Tamu'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
  ...
  object zqryDisplay: TZQuery
    ...
    SQL.Strings = (
      ...
      'and a.cara_bayar='#39'KREDIT'#39' and a.isclosed='#39'1'#39
      'order by a.dt_nota')
    Params = <
      item
        DataType = ftUnknown
  ...
  object PopUpBayar: TAdvPopupMenu
    Version = '2.6.4.0'
    Left = 264
    Top = 72
    object btnBayar: TMenuItem
      Caption = 'Bayar'
