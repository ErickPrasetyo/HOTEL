...
type
  TBayarNotaKredit = class(TForm)
    ...
    qNotanama_tamu: TStringField;
    Label3: TLabel;
    dblblNama: TcxDBLabel;
    qNotajns_pembayaran: TStringField;
...
var
  BayarNotaKredit: TBayarNotaKredit;
...
procedure TBayarNotaKredit.btnBatalClick(Sender: TObject);
begin
  ModalResult:= mrCancel;
end;

procedure TBayarNotaKredit.btnBayarClick(Sender: TObject);
begin
...
procedure TBayarNotaKredit.edtBayarKeyPress(Sender: TObject; var Key: Char);
begin
  if  (qNotajns_pembayaran.IsNull) or (qNotajns_pembayaran.AsString='') then
...
procedure TBayarNotaKredit.edtBayarPropertiesEditValueChanged(Sender: TObject);
begin
  qNota.Edit;
  qNotashift.AsInteger:= DataModule1.intgrfldShiftshift_server.AsInteger;
  qNotasisa.AsFloat:= qNotatotal.AsFloat-qNotadibayar.AsFloat;
end;

procedure TBayarNotaKredit.edtCaraBayarPropertiesCloseUp(Sender: TObject);
begin
...
procedure TBayarNotaKredit.FormShow(Sender: TObject);
begin
...
procedure TBayarNotaKredit.qNotaCalcFields(DataSet: TDataSet);
begin
//  qNotasisa.AsFloat:= qNotatotal.AsFloat-qNotadibayar.AsFloat;
end;
