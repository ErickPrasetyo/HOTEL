...
procedure TBayar.btnBatalClick(Sender: TObject);
begin
  ModalResult:= mrCancel;
end;

procedure TBayar.btnBayarClick(Sender: TObject);
begin
...
procedure TBayar.edtBayarKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TBayar.edtBayarPropertiesEditValueChanged(Sender: TObject);
begin
  qNota.Edit;
  qNotasisa.AsFloat:= qNotatotal.AsFloat-qNotadibayar.AsFloat;
end;

procedure TBayar.edtCaraBayarPropertiesCloseUp(Sender: TObject);
begin
...
procedure TBayar.FormShow(Sender: TObject);
begin
  ...
  edtBayar.Text:= '0';
  edtNoKartu.Text:= '-';
  edtCaraBayar.Text:= 'TUNAI';
  lblNoKartu.Visible:= False;
  edtNoKartu.Visible:= False;

end;

procedure TBayar.qNotaCalcFields(DataSet: TDataSet);
begin
//  qNotasisa.AsFloat:= qNotatotal.AsFloat-qNotadibayar.AsFloat;
end;
