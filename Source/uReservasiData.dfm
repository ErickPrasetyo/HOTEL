object frmReservasiData: TfrmReservasiData
  Left = 0
  Top = 0
  Caption = 'Reservasi Data'
  ClientHeight = 660
  ClientWidth = 1139
  Color = clBtnFace
  ...
  object cxDBTreeListRoomData: TcxDBTreeList
    ...
    DataController.ParentField = 'id_reservasi'
    DataController.KeyField = 'id_reservasi'
    ...
    TabOrder = 0
    object cxDBTreeListRoomDatacxDBTreeListColumn5: TcxDBTreeListColumn
      Caption.Text = 'ID Reservasi'
      DataBinding.FieldName = 'id_reservasi'
      Width = 72
      Position.ColIndex = 0
      Position.RowIndex = 0
    ...
    object cxdbtreeColumnDBTreeListRoomDatadiskripsi: TcxDBTreeListColumn
      ...
      Caption.Text = 'Reservasi Description'
  ...
  object pnlHeader: TPanel
    ...
    object Label2: TLabel
      ...
      Height = 17
      AutoSize = False
      Caption = 'MASTER JENIS RESERVASI'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object Label1: TLabel
      ...
      Height = 49
      AutoSize = False
      Caption = 'Berisi master data Jenis Reservasi Registrasi Tamu'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
  ...
  object zqryDisplay: TZQuery
    ...
    SQL.Strings = (
      'select * from master.mreservasi'
      'order by id_reservasi;')
    Params = <>
    Left = 568
    Top = 16
    object zqryDisplayid_reservasi: TLargeintField
      FieldName = 'id_reservasi'
      Required = True
    end
    object zqryDisplaydiskripsi: TStringField
      FieldName = 'diskripsi'
      Size = 255
    end
