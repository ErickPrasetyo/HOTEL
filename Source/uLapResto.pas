...
procedure TfrmLapResto.AdvGlbtnExportClick(Sender: TObject);
var excel : Variant;
    appPath, ttl :string;
begin
...
procedure TfrmLapResto.InsertMemTabel;
begin
  try
...
procedure TfrmLapResto.CetakRekap;
begin
...
constructor TfrmLapResto.Create(AOwner: TComponent; aTag: Integer);
begin
  inherited Create(AOwner);
  vTag := aTag;
end;

procedure TfrmLapResto.CetakDetail;
begin
...
procedure TfrmLapResto.AdvGlbtnPrintClick(Sender: TObject);
begin
...
procedure TfrmLapResto.AdvGlBtnRefreshClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;

procedure TfrmLapResto.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 Action:= caFree;
 frmLapResto:=nil;
end;

procedure TfrmLapResto.FormShow(Sender: TObject);
begin
...
procedure TfrmLapResto.OpenDataset(idx:integer);
begin
  try
    case idx of
      0 : begin
...
procedure TfrmLapResto.tsDetailShow(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;

procedure TfrmLapResto.UpdateAccessControls;
...
procedure TfrmLapResto.wwDbDtpFromCloseUp(Sender: TObject);
var dt: TDateTime;
    y,m,d: Word;
begin
...
procedure TfrmLapResto.glbtnCLoseClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmLapResto.glbtnGoClick(Sender: TObject);
begin
  OpenDataset(pgLapResto.ActivePageIndex);
end;
